...
🛠 Tech Stack
LayerTechnologyFrontendReact, Recharts, React Icons, AxiosBackendFastAPI (Python)DatabaseSQLiteNLP ModelHugging Face twitter-roberta-base-sentiment
...
Enter text in the input field and press Analyze or hit Enter
View your sentiment result and confidence pie chart
Browse past analyses in the sidebar
Click any history item to open a detailed modal
Hit the 🎤 button to use voice input
